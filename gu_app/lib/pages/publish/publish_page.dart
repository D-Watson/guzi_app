      ...
      child: Container(
        ...
        child: Row(children: [
          Container(width: 40, height: 40, decoration: BoxDecoration(
            color: Color(AppColors.getPlaceholderColor(ip.id.hashCode)),
            borderRadius: BorderRadius.circular(8),
          )),
                ...
                return Stack(
                  children: [
                    Container(
                      width: 100, height: 100,
                      decoration: BoxDecoration(
                        color: Color(AppColors.getPlaceholderColor(index)),
                        borderRadius: BorderRadius.circular(8),
                      ),
  ...
  Widget _buildStep3TradeMode() {
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        _buildTradeTypeCard(icon: Icons.sell, title: '一口价现货', desc: '买家直接付款，24小时内安排发货，适合有现货的卖家', isSelected: _tradeType == TradeType.fixedPrice, onTap: () => setState(() => _tradeType = TradeType.fixedPrice)),
        const SizedBox(height: 10),
        _buildTradeTypeCard(icon: Icons.payments, title: '定金+尾款', desc: '买家先付定金锁定名额，到货后支付尾款，适合定制/预售商品', isSelected: _tradeType == TradeType.depositFinal, onTap: () => setState(() => _tradeType = TradeType.depositFinal)),
        const SizedBox(height: 10),
        _buildTradeTypeCard(icon: Icons.groups, title: '发起拼团', desc: '招募同好一起购买，满员后统一发货，适合批量购买降低单价', isSelected: _tradeType == TradeType.groupBuy, onTap: () => setState(() => _tradeType = TradeType.groupBuy)),
        const SizedBox(height: 24),
